...
<div class="container">
    <div class="logo"><img  src="{{ asset('uploads/'.get_general_value('website_logo')) }}"
     alt="cc-logo" border="0">
    </div>
    <div class="illustration">
      <div class="hgroup">
        <span class="name">مرحبا بك في {{get_general_value('website_name')}}, {{ $name }}</span>
