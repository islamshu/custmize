...
<div class="main row">
    <div class="col-3  " style="border-right: 1px solid #ececec;">
        <div class="" id="rightLayoutContainer">

            <h4 class="" style="margin-bottom: 25px;">خيارات الطباعة </h4>
            ...
            <h4 class="mt-3 mb-2">اضف اللوجو الخاص بك</h4>
            ...
            <h4 class="mt-3 mb-3">اتجاهات الصورة</h4>
    ...
    <div class="col-6">
        <div class="" id="centerLayoutContainer">
                ...
                <div class="div_reviewbtn d-flex">
                    ...
                    <div class="dropup">
                        <button class="btn btn-default dropdown-toggle Download" type="button"
                            ...
                            aria-expanded="false">
                            <i class="fa fa-save"></i> تحميل
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownDownload">
                            <li><a href="#" id="btnDownloadDesign"> التصميم</a></li>
                            <li><a href="#" id="btnDownloadShirt">العنصر مع التصميم </a></li>
                        </ul>
                    </div>
                    <button type="button" class="btn btn-default Preview" {{-- data-toggle="modal"
                    data-target="#reviewModal" --}}
                    onclick="loadProductData()"><i class="fa fa-eye"></i> مشاهدة</button>
                </div>
                <button id="confirm_side" class="btn btn-warning confirmd">اعتماد هذه الواجهة</button>
            ...
            <div id="div_colors_title" class="color">
                <h4 style="text-align: center">الألوان</h4>
            ...
            @if ($product->sizes != null)
                <h4 class="text-center mt-2">الأحجام</h4>
                <div class="size">
            ...
            @if ($product->type_id != null)
                <h4 class="text-center mt-4">النوع</h4>
                <div class="material">
                    <span class="active"
                     data-value="{{ $product->type_id }}"   data-material="{{ App\Models\TypeCategory::find($product->type_id)->name }}">{{ App\Models\TypeCategory::find($product->type_id)->name }}</span>
                </div>
            @endif
    ...
    <div class="col-3" style="border-left: 1px solid #ececec;padding-left: 15px;"
        ...
        <div class="rightLayout" id="leftLayoutContainer">
            ...
            <p class="fs-16 mb-2 ibm-plex-sans-arabic-medium">التوصيل</p>
            <a href="" class="delivery">4 - 9 october</a>

            <div class="product-iamges">
                <h4 class="mb-2"> الصور التوضيحية</h4>
        ...
        <div class="btns">
            ...
            <a href="">الشراء الآن </a>
        </div>

        <div class="price d-flex">
            <div class="">
                <span class="fs-16">سعر الوحدة </span>
                <h3 class="fs28" id="main_price">$
                    00</h3>
            </div>

            <div class="">
                <span class="fs-16"> السعر الاجمالي</span>
