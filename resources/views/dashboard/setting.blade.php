                                        ...
                                        <form class="form" action="{{ route('add_general') }}" method="post"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 mb-2">
                                                        ...
                                                        <input type="text"
                                                            value="{{ get_general_value('website_name') }}" id="userinput2"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 mb-2">
                                                    ...
                                                    <input type="text" value="{{ get_general_value('front_url') }}"
                                                        id="userinput2" required class="form-control border-primary"
                                                        placeholder="{{ __('رابط موقع الفورنت') }}"
                                                        name="general[front_url]">
                                                    <div class="invalid-feedback">
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 mb-2">
                                                    ...
                                                    <input type="text"
                                                        value="{{ get_general_value('whatsapp_number') }}"
                                                        id="userinput2" required class="form-control border-primary"
                                                        placeholder="{{ __('whatsapp number') }}"
                                                        name="general[whatsapp_number]">
                                                    <div class="invalid-feedback">
                                                    </div>
                                                </div>
                                            </div>
