                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-user nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{ route('edit_profile') }}"><i
                                ...
                                <a class="dropdown-item" href="#"><i class="ft-check-square"></i> {{ __('Task') }}</a>
                        ...
                        <li class="dropdown dropdown-language nav-item">
                            ...
                            <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                    class="flag-icon @if (app()->getLocale() == 'ar') flag-icon-sa @else flag-icon-gb @endif ">
                                </i>
                                <span class="selected-language"></span></a>

                            <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                                <a class="dropdown-item" href="{{ route('change_lang','en') }}"><i class="flag-icon flag-icon-gb"></i>
                                    English</a>
                                <a class="dropdown-item" href="{{ route('change_lang','ar') }}"><i class="flag-icon flag-icon-sa"></i>
                                    العربية</a>
