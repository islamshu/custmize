    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Types') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('Types') }}
                            </li>
                        </ol>
                    </div>
                </div>
...
<script>
   ...
   $("#add_fast_type").submit(function(event) {
       event.preventDefault();
       ...
       $.ajax({
           type: 'POST',
           url: url,
           data: new FormData($('#add_fast_type')[0]),
            processData: false,
            contentType: false,        
