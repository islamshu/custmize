    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Sub Categories') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('Sub Categories') }}
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="{{ route('subcategories.create') }}" class="btn btn-success mb-3">{{ __('Add New') }}</a>
                                        ...
                                        <tbody>
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('subcategories.edit', $category->id) }}" class="btn btn-warning"><i
                                                            class="ft-edit"></i></a>
                                
                                                        <form action="{{ route('subcategories.destroy', $category->id) }}" method="POST" style="display: inline-block;">
                                                            @csrf
                                                            @method('DELETE')
