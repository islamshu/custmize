<div class="modal fade text-left" id="extra_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form" action="{{ route('add_extra') }}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="type_name" value="client" id="">
                ...
                <div id="car_parent">
                    ...
                    <div id="extra">
                        <input type="hidden" value="{{ App\Models\Extra::where('table','client')->count() }}"  id="count_tt">
                        @foreach (App\Models\Extra::where('table','client')->get() as $key=> $item)
